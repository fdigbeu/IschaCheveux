...
use Ischa\BackOfficeBundle\Entity\Commande;
use Ischa\BackOfficeBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commandes = $em->getRepository('IschaBackOfficeBundle:Commande')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Ischa\BackOfficeBundle\Form\CommandeType', $commande);
    ...
    {
        $deleteForm = $this->createDeleteForm($commande);
        $editForm = $this->createForm('Ischa\BackOfficeBundle\Form\CommandeType', $commande);
